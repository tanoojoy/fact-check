...
class DepartmentPageFilter extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			pageSize: 20,
	...
	handlePageSizeSelect(pageSize) {
		this.props.filterApprovalList(pageSize, this.props.workflows ? this.props.workflows.PageNumber : 1, "Departments");
...
module.exports = DepartmentPageFilter;