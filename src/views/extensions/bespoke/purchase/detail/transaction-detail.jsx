...
class TransactionDetailComponent extends BaseComponent {
    ...
    getPaymentType() {
        let paymentType = 'N/A';
        const order = this.props.detail.Orders[0];
        const paymentDetails = order.PaymentDetails;
        if (paymentDetails && paymentDetails[0] && paymentDetails[0].Gateway.Gateway) {
            paymentType = paymentDetails[0].Gateway.Gateway;
        }
        return paymentType;
    }
                ...
                <div className="oscc-tbl full-width">
                    <div className="oscct-top full-width">
                        <div className="occt-left">
                            <span className="title">Invoice ID </span>
