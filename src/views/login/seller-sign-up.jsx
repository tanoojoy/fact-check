...
class SellerSignUpComponent extends BaseComponent {
    constructor(props) {
        super(props);
    ...
    renderCustomSignUp() {
        const self = this;
        return (
            <form key="custom-signup" id="frmlogin" action="/accounts/seller/sign-up" method="post" autoComplete="off">
                <div className="lbb-input">
                    ...
                    <input type="text" className="input-text notification-email" placeholder="Notification Email" name="email" data-react-state-name="notificatonEmail" onKeyDown={(e) => this.avoidWhiteSpaceOnKeyDown(e)} value={this.state.notificatonEmail} onChange={(e) => this.onChange(e)} />
                </div>
                <br />
                <div className="btn-signin">
                    <a href="#" ref={self.submitButton} onClick={(e) => self.onCreateAccount(e)}>Sign Up</a>
                </div>
            </form>
        );
    }
                        ...
                        <div className="login-box">
                            ...
                            <div className="lb-body full-width">
                                ...
                                <div className="lbb-bottom-text">
                                    ...
                                    <span><a href="/accounts/seller/sign-in">Login</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
const SellerSignUpReduxConnect = ReactRedux.connect(
    mapStateToProps,
    mapDispatchToProps
