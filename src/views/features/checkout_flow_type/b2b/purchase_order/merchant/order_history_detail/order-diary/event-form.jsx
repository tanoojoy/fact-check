...
class EventFormComponent extends React.Component {
    ...
    addNewEvent(e) {
        ...
        this.props.validatePermissionToPerformAction('add-merchant-purchase-order-details-api', () => {
            if (self.validInput()) {
                    ...
                    <div className="entry-form-prnt">
                        ...
                        <div className="entry-btns">
                            <PermissionTooltip isAuthorized={this.props.isAuthorizedToAdd} extraClassOnUnauthorized={'icon-grey'}>
                                <button className="sassy-black-btn" id="addNewEntry" onClick={(e) => this.addNewEvent(e)}>Add new entry</button>
                            </PermissionTooltip>
                        </div>
                    </div>
                </div>
